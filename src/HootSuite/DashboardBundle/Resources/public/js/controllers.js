...
hootControllers.controller('MessagesController', function($scope, $rootScope, geolocation, Profiles, Redes, Message, dialogs, notify,Upload,$filter){
    $rootScope.message = {};
    $rootScope.profiles = [];
    ...
    $rootScope.searchTwitter = function(){
        $scope.boxclass = "icon-sn-16 twitter";
        console.log($scope.boxclass);
    }
    $rootScope.findTwitterUsers = function(){
        $scope.boxclass = "icon-19 account";
        console.log($scope.boxclass);
    }
    $rootScope.searchInstagram = function(){
        $scope.boxclass = "icon-sn-16 instagram";
        console.log($scope.boxclass);
    }
